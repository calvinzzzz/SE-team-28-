...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix' '/app/vendor/ruby-2.6.6' '--enable-load-relative'"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lpthread -lrt -lrt -ldl -lcrypt -lm "
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Ubuntu 4.8.4-2ubuntu1~14.04.4) 4.8.4\nCopyright (C) 2013 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
